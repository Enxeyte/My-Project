# 18'1 Capstone Project
# Receive Laundry State from Arduino(WeMos D1 R2) using Socket Communication
# Send Laundry State to ARTIK Cloud when Laundry State change
